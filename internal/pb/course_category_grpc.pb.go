...
const (
	...
	CategoryService_ListCategoryById_FullMethodName                  = "/pb.CategoryService/ListCategoryById"
...
type CategoryServiceClient interface {
	...
	ListCategoryById(ctx context.Context, in *CategoryListById, opts ...grpc.CallOption) (*Category, error)
...
func (c *categoryServiceClient) ListCategoryById(ctx context.Context, in *CategoryListById, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
	err := c.cc.Invoke(ctx, CategoryService_ListCategoryById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	ListCategoryById(context.Context, *CategoryListById) (*Category, error)
...
func (UnimplementedCategoryServiceServer) ListCategoryById(context.Context, *CategoryListById) (*Category, error) {
...
func _CategoryService_ListCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_ListCategoryById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategoryById(ctx, req.(*CategoryListById))
	}
	return interceptor(ctx, in, info, handler)
}
