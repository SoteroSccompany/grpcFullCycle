...
func (x *CategoryListById) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryListById) ProtoMessage() {}

func (x *CategoryListById) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryListById.ProtoReflect.Descriptor instead.
func (*CategoryListById) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{4}
}

func (x *CategoryListById) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5d, 0x0a, 0x15, 0x55,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x22, 0x0a, 0x10, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x79, 0x49, 0x64, 0x12, 0x0e,
	...
	0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x32, 0x93, 0x03, 0x0a,
	...
	0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x2f, 0x0a, 0x0e, 0x4c, 0x69,
	...
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x10, 0x4c,
	0x69, 0x73, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42, 0x79, 0x49, 0x64, 0x12,
	0x14, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73,
	0x74, 0x42, 0x79, 0x49, 0x64, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43,
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CategoryListById)(nil),      // 4: pb.CategoryListById
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.ListCategoryById:input_type -> pb.CategoryListById
	3, // 6: pb.CategoryService.UpdateCategory:input_type -> pb.UpdateCategoryRequest
	...
	1, // 11: pb.CategoryService.ListCategoryById:output_type -> pb.Category
	1, // 12: pb.CategoryService.UpdateCategory:output_type -> pb.Category
